/*
  Exchange Online Alert Relay Controller for ESP32-C3
  Grove - Relay制御プログラム
...
// リレー設定
const int RELAY_PIN = 10;          // GPIO 10（D10）- Grove - Relay接続GPIO番号
...
void setup() {
  ...
  Serial.println("\n\n");
  Serial.println("============================================================");
  Serial.println("Exchange Online Alert Relay Controller for ESP32-C3を起動しました");
  Serial.println("============================================================");
